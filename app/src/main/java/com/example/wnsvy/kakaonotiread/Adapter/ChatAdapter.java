...
public class ChatAdapter extends RealmRecyclerViewAdapter<Users, ChatAdapter.ViewHolder> {
    ...
    public ChatAdapter(@Nullable RealmResults<Users> data, boolean autoUpdate, Context context, String type) {
    ...
    public ChatAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.list_chat_item, viewGroup, false);
